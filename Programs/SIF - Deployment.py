...
"""
        ...
        Results = """
                <div style="text-align: justify;">
                According to the observations while training the model we observed a cv-score of 0.45 , which is a low score as compared to what we recieved while using the TabNet Model where it also got a score of 0.269 when we fitted the data in the model by excluding the rainfall part.
                </div>
                """
